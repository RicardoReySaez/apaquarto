...
+------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `impact-statement`           | A paragraph on a separate page after the Abstract that describes the theoretical/practical importance of the work. The heading of the impact statement is "Translational Abstract" by default but can be overridden using the `title-impact-statement` field in the `language` field.                                                                                                                                                                                   |
+------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

: {.primary tbl-colwidths="\[25,75\]"}

Two additional title-page helpers are available:

``` yaml
supplementary-material: true
```

When `supplementary-material` (or `supplementary_material`) is `true`, the title page is labeled as supplementary material and the running head is set to "Supplementary Material".

In supplementary material, the title is not repeated on the first manuscript page. Tables and figures are numbered with an `S` prefix by default (for example, Table S1 and Figure S1), and level-1 manuscript headings are prefixed as `SM1:`, `SM2:`, and so on. These defaults can be disabled:

``` yaml
supplementary-float-prefix: false
supplementary-section-prefix: false
```
...
When `publication-statement` (or `publication_statement`) is supplied, the statement is placed at the bottom of the first title page. The `journal` field creates the standard accepted-in-journal sentence. Use `statement` to add custom wording immediately after that sentence. Use `apa-year` to add the standard APA notice; `year` is also supported for older documents. If `doi` is supplied without `apa-year`, it is added as a DOI hyperlink at the end.
...
The apaquarto extension uses the [standard Quarto schema for affiliations](https://quarto.org/docs/journals/authors.html#affiliations-schema).
...
| [`editing`](https://credit.niso.org/contributor-roles/writing-review-editing/) | Preparation, creation and/or presentation of the published work by those from the original research group, specifically critical review, commentary or revision -- including pre- or post-publication stages. |
...
|                         | ```                                                                                                                              |
+-------------------------+----------------------------------------------------------------------------------------------------------------------------------+
| `ai-statement`          | Disclose how artificial intelligence tools were used in the work.                                                                |
|                         |                                                                                                                                  |
|                         | Example:                                                                                                                         |
|                         |                                                                                                                                  |
|                         | ``` yaml                                                                                                                         |
|                         | author-note:                                                                                                                     |
|                         |   disclosures:                                                                                                                   |
|                         |     ai-statement: "The authors used AI tools to improve grammar and clarity and reviewed all generated text."                    |
|                         | ```                                                                                                                              |
+-------------------------+----------------------------------------------------------------------------------------------------------------------------------+
...
All of the .pdf-specific options for apaquarto come directly from the [apa7 $\LaTeX$ package](https://ctan.org/pkg/apa7?lang=en). Consult the \[apa7 package documentation\](<https://ctan.org/pkg/apa7>) for greater detail.

+--------------------+-------------------------------------------------------------------------------+
| Field              | Explanation                                                                   |
+====================+===============================================================================+
| `documentmode`     | Alter the overall style of the document. Options include:                     |
|                    |                                                                               |
...
| `note`             | professor: W. Joel Schneider                                                  |
|                    | duedate: 12/22/2024                                                           |
|                    | note: |                                                                       |
|                    |   Student ID: 123456                                                          |
|                    | ```                                                                           |
...
| `suppress-disclosures-paragraph: true` | Suppress the paragraph about disclosures (study registration, data sharing, related reports, conflicts of interest, financial support, statements of gratitude, authorship agreements, and AI statements) |
...
| `title-impact-statement` | The heading for the impact statement | *Translational Abstract* |
...
|----------------------------------------|-----------------------|
| `section-title-abstract: Abstract`     | Abstract title        |
