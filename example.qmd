...
# If true, the title page is formatted for supplementary material and the running head becomes "Supplementary Material".
supplementary-material: false
# These are enabled automatically when supplementary-material is true; set either to false to disable.
# supplementary-float-prefix: true
# supplementary-section-prefix: true
# Optional publication statement for accepted manuscripts.
...
author-note:
  ...
  disclosures:
    ...
    # Example: The authors used AI tools to improve grammar and clarity and reviewed all generated text.
